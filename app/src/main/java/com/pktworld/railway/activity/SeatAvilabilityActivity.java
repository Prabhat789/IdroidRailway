...
import com.pktworld.railway.adapter.AvailabilityAdapter;
import com.pktworld.railway.adapter.SimpleListAdapter;
import com.pktworld.railway.model.QuotaCodes;
import com.pktworld.railway.model.SeatAvilabilityResponse;
...
public class SeatAvilabilityActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        if (v == btnSelectDate){
            ...
            if (validate()){
                if (Utils.isConnected(SeatAvilabilityActivity.this)){
    ...
    private boolean validate(){
        if (editTrainNumber.getText().toString().trim().length() == 0 || editTrainNumber.getText().toString().trim().isEmpty()){
            Utils.showToastMessage(SeatAvilabilityActivity.this, "Please enter Train Number");
            return false;
        }else if (editSourcestation.getText().toString().trim().length() == 0 || editSourcestation.getText().toString().trim().isEmpty()){
            Utils.showToastMessage(SeatAvilabilityActivity.this, "Please enter Source Station Code");
            return false;
        }else if (editDestinationStation.getText().toString().trim().length() == 0 || editDestinationStation.getText().toString().trim().isEmpty()){
            Utils.showToastMessage(SeatAvilabilityActivity.this, "Please enter Destination Station Code");
            return false;
        }
        else if (btnSelectDate.getText().toString().equalsIgnoreCase("date")){
            Utils.showToastMessage(SeatAvilabilityActivity.this,"Please select date");
            return false;
        }
        else if (btnSelectQuota.getText().toString().equalsIgnoreCase("quota")){
            Utils.showToastMessage(SeatAvilabilityActivity.this,"Please select Quota");
            return false;
        }
        else if (btnClass.getText().toString().equalsIgnoreCase("class")){
            Utils.showToastMessage(SeatAvilabilityActivity.this,"Please select Class");
            return false;
        }else {
            return true;
        }
            ...
            public void onResponse(SeatAvilabilityResponse response) {
                try {
                    ...
                    if (response.getResponse_code().equals("200")){
                        ...
                        Utils.showToastMessage(SeatAvilabilityActivity.this,getString(R.string.empty_response));
                    }
