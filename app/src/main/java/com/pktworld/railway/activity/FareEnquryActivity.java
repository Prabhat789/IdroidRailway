...
import com.pktworld.railway.adapter.FareAdapter;
import com.pktworld.railway.adapter.SimpleListAdapter;
import com.pktworld.railway.model.FareEnquiryResponse;
...
public class FareEnquryActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        if (v == btnGo){
            if (validate()){
                if (Utils.isConnected(FareEnquryActivity.this)){
            ...
            public void onResponse(FareEnquiryResponse response) {
                try {
                    ...
                    if (response.getResponse_code().equals("200")){
                        ...
                        Utils.showToastMessage(FareEnquryActivity.this,getString(R.string.empty_response));
                    }
