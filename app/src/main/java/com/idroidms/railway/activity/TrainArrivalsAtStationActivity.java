...
import com.idroidms.railway.adapter.TrainArrivalAtStationAdapter;
...
public class TrainArrivalsAtStationActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    public void onClick(View v) {
        if (v == btnSearch){
            if (validate()){
                if (AppUtils.isConnected(TrainArrivalsAtStationActivity.this)){
    ...
    private boolean validate(){
        if (editHours.getText().toString().trim().length() == 0 || editHours.getText().toString().trim().isEmpty()){
            AppUtils.showToastMessage(TrainArrivalsAtStationActivity.this,"Please enter Hours");
            return false;
        }else if (editStationCode.getText().toString().trim().length() == 0 || editStationCode.getText().toString().trim().isEmpty()){
            AppUtils.showToastMessage(TrainArrivalsAtStationActivity.this,"Please enter Station Code");
            return  false;
        }else{
            return  true;
        }
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if (response1.getString("response_code").equals("200")){
                                ...
                                AppUtils.setListViewHeightBasedOnChildren(listArrivesTrain);
                                ...
                                AppUtils.showToastMessage(TrainArrivalsAtStationActivity.this,getString(R.string.empty_response));
                            }
