...
import com.idroidms.railway.adapter.PassangerAdapter;
    ...
    public void onClick(View v) {
        if (v == btnSubmit){
            if (editPnr.getText().toString().trim().isEmpty() || editPnr.getText().toString().length() == 0){
                AppUtils.showToastMessage(PnrStatusActivity.this,"Enter Pnr Number");
            }else {
                if (AppUtils.isConnected(PnrStatusActivity.this)){
            ...
            public void onResponse(PnrResponse response) {
                try {
                    ...
                    if (response.getResponse_code().equals("200")){
                        ...
                        AppUtils.showToastMessage(PnrStatusActivity.this,"Invalid PNR Number");
                    }
