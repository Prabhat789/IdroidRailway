...
import com.idroidms.railway.parseutils.SpacesItemDecoration;
 ...
 */
public class GotBoardFragment extends Fragment implements View.OnClickListener{
                ...
                try {
                    ...
                    if (response.getResponse_code().equals("200")){
                        ...
                        if (chartPrepared.equalsIgnoreCase("Y")){
                            ...
                            AppUtils.showToastMessage(getActivity(),"Chart Not Prepared at");
                        }
                        ...
                        AppUtils.showToastMessage(getActivity(),"Invalid PNR Number");
                    }
