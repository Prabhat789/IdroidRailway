...
import com.idroidms.railway.activity.SlideMenuActivity;
        ...
        ParseUser.logInInBackground(username, password, new LogInCallback() {
            public void done(ParseUser user, ParseException e) {
                ...
                if (user != null) {
                    ...
                    AppUtils.showToastMessage(mContext, mContext.getResources().getString(R.string.invalid_user));
                }
            }
        });
    }
        ...
        user.signUpInBackground(new SignUpCallback() {
            public void done(ParseException e) {
                ...
                if (e == null) {
                    ...
                    AppUtils.showToastMessage(mContext, mContext.getString(R.string.unable_to_process_request));
                }
            }
        });
    }
