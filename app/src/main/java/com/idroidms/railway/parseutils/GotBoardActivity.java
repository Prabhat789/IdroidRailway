...
import com.idroidms.railway.fragments.ChatRoomFragment;
    ...
    public void onClick(View v) {
        if (v == btnSearchGroup){
            if (editTrainNumber.getText().toString().length() !=0 || !editTrainNumber.getText().toString().isEmpty()){
                ...
                AppUtils.showToastMessage(GotBoardActivity.this,"Please enter your PNR Number");
            }
                ...
                try {
                    ...
                    if (response.getResponse_code().equals("200")){
                        ...
                        if (chartPrepared.equalsIgnoreCase("Y")){
                            ...
                            AppUtils.showToastMessage(GotBoardActivity.this,"Chart Not Prepared at yet");
                        }

                    }else {
                        AppUtils.showToastMessage(GotBoardActivity.this,"Invalid PNR Number");
                    }
                    ...
                    Log.e(TAG, "TryCatch");
                    AppUtils.showToastMessage(GotBoardActivity.this,"Unable to get PNR status");
                }
            };
        };
    }
